...
This document is the engineering counterpart to `QIDO_PLAN.md` (the design) and `ISC_DELIVERABLES.md` (the scope). Read this if you want to review the code itself or sign off on it.
