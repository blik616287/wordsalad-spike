...
> Technical reference for the DICOMweb work on **ChRIS_ultron_backEnd (CUBE)**.
> Purpose: end-to-end grounding in the platform architecture. Every non-obvious claim is cited inline.
>
