...
> **Audience**: an engineer adding DICOMweb to CUBE.
> This document describes the **existing** REST API — what every
...
filtering for almost every view. Most "why does X happen?" questions
resolve here.
