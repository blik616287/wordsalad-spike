...
> STOW scope, pg_trgm) see `proposal/RESEARCH_TICKET_OUTPUT.md`.
>
...
`models.py:54`). This is decision **D2** in `proposal/RESEARCH_TICKET_OUTPUT.md`.
...
This is the single most common point of confusion. There are two distinct ways a
...
This is the subtlest fix. **DRF's per-view `csrf_exempt`
...
D2 (`proposal/RESEARCH_TICKET_OUTPUT.md`). An explicit Study row is the recommended
...
- Decisions (D1 variants, D2 PACSStudy, D4 pg_trgm): `proposal/RESEARCH_TICKET_OUTPUT.md`.
