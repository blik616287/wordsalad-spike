...
> **Purpose.** This is the reference for the question *"how do you know it actually
> works?"* It is the **evidence ledger** for the L2
...
confirmed by hand over the wire. The live run is what lets us say "we watched it
...
These are the demonstrations most likely to draw a hard question, because they sound too
...
**Key point.** Bugs #7, #8, #10, #11 are the headline ones: each was
...
## 8. "How do you KNOW it works?" — Q&A

Short, specific answers. Each ends with the evidence to cite.
