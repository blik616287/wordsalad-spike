...
# DICOMweb STOW-RS bodies (multipart/related of DICOM objects) routinely exceed
# Django's 2.5MB DATA_UPLOAD_MAX_MEMORY_SIZE default -- real CT/MR instances,
# enhanced/multi-frame objects, and multi-instance (series) bodies. Disable the
# in-memory cap so STOW accepts full-size bodies (production caps at the proxy).
