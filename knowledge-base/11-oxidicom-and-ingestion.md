...
>
> **Audience:** an ISC engineer who is the expert in the room but new to this stack.
...
> **Curve-ball implication:** the set of PACS identifiers in CUBE is whatever set of calling AETs has
...
This is the best curve-ball. Be ready to walk through it end to end.
...
thing. A common confusion in the room.
...
assuming the curve-ball is gone in your deployment.
