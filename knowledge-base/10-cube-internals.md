...
> **Audience:** Marty (ISC), the technical expert in the BCH stakeholder meeting, new to the
> ChRIS stack. **Purpose:** field curve-ball questions about *how CUBE is actually built* —
