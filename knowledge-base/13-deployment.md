...
wrap) and `08-l2-architecture-decisions.md` (the architecture the overlay
...
These are the curve-ball-worthy ones. Each was found on a live host on
...
This mirrors `08-l2-architecture-decisions.md`: the recommended hybrid (option C)
